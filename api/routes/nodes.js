...
router.post('/:node', function (req, res, next) {
  var params = [req.body.name, req.body.type, req.body.markdown_content, req.body.horizontal_image_node, req.body.vertical_image_node, req.body.icon, req.body.node_uuid];
