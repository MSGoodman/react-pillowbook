...
const buttons = [
    ...
    new Button('Toilet', 'Health', 'fas fa-toilet', 'Times using the toilet', 'TOILET'),
    new Button('Sleep', 'Health', 'fas fa-bed', 'Times slept', 'SLEEP'),
    ...
    // Food
    new Button('Dish', 'Food & Drink', 'fas fa-hamburger', 'A dish; e.g. chicken pargmigiano, samgyetang', 'DISH'),
    new Button('Recipe', 'Food & Drink', 'fas fa-blender', 'A recipe for a dish', 'RECIPE'),
    ...
    new Button('Video', 'Consumption', 'fas fa-forward', 'Videos watched', 'VIDEO'),
    ...
    new Button('Webpage', 'Consumption', 'fas fa-sitemap', 'Websites visited', 'WEBPAGE'),
